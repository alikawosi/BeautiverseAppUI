...
import {Defs, Image, Mask, Rect, Svg} from 'react-native-svg';
...
const CameraVerification = () => {
  ...
  const {verificationSteps} = SETTING_CONST;
    ...
    <View
      ...
      {checkImag ? (
        ...
        <Camera
          ...
          ref={cameraRef}
          device={
            verificationSteps < 7 ? params.device.back : params.device.front
          }
          isActive={isFocused}
